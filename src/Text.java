...
public class Text {
	...
	public Text(MainBody main, Items items){
		this.main = main;
		this.items = items;
	}
	...
	public void location_text(){
		if (main.room.getID() == "x0y3"){
		...
		}else if (main.room.getID() == "x1y1"){
			main.addMessage("You find yourself on the beach.", "AI");	
			main.addMessage("To the west is the ocean.", "AI");
			//main.addMessage("x1y1", "AI");
		}else if (main.room.getID() == "x1y2"){
			main.addMessage("You find yourself on the beach.", "AI");	
			main.addMessage("To the west is the ocean.", "AI");
		...
		}else if (main.room.getID() == "x1y6"){
			main.addMessage("You find yourself on the dunes of the beach.", "AI");
			main.addMessage("To the south is a shack.", "AI");
			//main.addMessage("x1y6", "AI");
		}else if (main.room.getID() == "Shack Main Room"){
		...
		}else if (main.room.getID() == "Shack Cellar"){
		...
		}else if (main.room.getID() == "Plane Passenger"){
			main.addMessage("To the east is a beach. To the west is forst.", "AI");
		...
		}else if (main.room.getID() == "Plane Sotrage"){
			main.addMessage("To the east is a beach. To the west is forst.", "AI");
			...
			main.addMessage("The door to go out is to the north.", "AI");
			//main.addMessage("MainRoom", "AI");
		}else if (main.room.getID() == "House Trapdoor Room"){
		...
		}else if (main.room.getID() == "House Box Room"){
		...
		}else if (main.room.getID() == "House Attic"){
